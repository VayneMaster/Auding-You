...
export default function HomeScreen() {
  ...
  useEffect(() => {
    setOnHome(pathname === '/'); // if not '/', we're in a different tab
  }, [pathname]);
  ...
  const openTab = (path: ValidPath) => {
    ...
    router.replace({ pathname: path }); // replaces current view with tab screen
  };
    ...
    <View style={styles.container}>
      ...
      {menuVisible && (
        <View style={styles.menu}>
          <TouchableOpacity style={styles.menuItem} onPress={() => openTab('/brainwaker')}>
      ...
      {onHome && !menuVisible && (
        <View style={styles.contentBox}>
          ...
          <TouchableOpacity style={styles.button} onPress={() => openTab('/brainwaker')}>
